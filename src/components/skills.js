  ...
  return (
    <div className="flex flex-col items-center justify-center gap-8 mt-16">
      ...
      {skills.map((skill) => (
          <div
            key={skill.name}
            className="flex flex-col items-center justify-center p-4 bg-gray-800 rounded-lg shadow-md hover:scale-105 transition-transform ease-in-out duration-300"
          >
